...
useEffect(()=>{
    ...
    <div className="avatar">
        ...
        <div className={fadeStatus} dangerouslySetInnerHTML={{__html: readme}} style={{margin: "auto", display: "flex",flexDirection:"column", alignItems: "center", justifyContent: "center", width: "90%" }}>
        </div>
